...
@Component({
  selector: 'app-datepicker-wrapper-mask-a2',
  templateUrl: './datepicker-wrapper-mask-a2.component.html',
  styleUrls: ['./datepicker-wrapper-mask-a2.component.scss'],
  providers: [
...
export class DatepickerWrapperMaskA2Component implements OnInit, AfterViewInit {
  @Input() config: DateFormatOutputFNS = DateFormatOutputFNS["yyyy-mm-dd"];
  @Input() control!: FormControl;
  @Input() show_guide!: boolean;
  ...
  ngOnInit(): void {
    this.mask.guide = this.show_guide;
  }
